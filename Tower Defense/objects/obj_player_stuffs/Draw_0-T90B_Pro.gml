...
switch(state) {
	...
	if (key_one) then {
		...
		pending_place = obj_tower_basic
		pending_sprite = spr_tower_basic
	...
	draw_sprite_ext(pending_sprite, 0, grid_mouse_x*GRIDSIZE_WIDTH+32, grid_mouse_y*GRIDSIZE_HEIGHT+32, 2, 2, 0, c_white, 0.5)
	
	switch(pending_place) {
		
		case obj_tower_basic:
		#region
